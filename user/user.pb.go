...
type UpdateUserRequest struct {
	...
	User *User `protobuf:"bytes,1,opt,name=user,proto3" json:"user,omitempty"` // Обновляемый пользователь
}
...
var file_user_proto_rawDesc = []byte{
	...
	0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x22, 0x4b, 0x0a, 0x14, 0x43, 0x68, 0x65, 0x63, 0x6b,
	...
	0x77, 0x6f, 0x72, 0x64, 0x22, 0x2d, 0x0a, 0x15, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x50, 0x61, 0x73,
	...
	0x6c, 0x69, 0x64, 0x32, 0xc2, 0x02, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76,
	...
	0x12, 0x36, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x42, 0x79, 0x49, 0x44, 0x12, 0x14, 0x2e, 0x75, 0x73,
	...
	0x73, 0x65, 0x12, 0x44, 0x0a, 0x09, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x50, 0x61, 0x73, 0x73, 0x12,
	...
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x77, 0x61, 0x74, 0x63, 0x68, 0x6c, 0x69, 0x73, 0x74,
	0x2d, 0x6b, 0x61, 0x74, 0x61, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x75, 0x73, 0x65,
...
var file_user_proto_depIdxs = []int32{
	...
	1,  // 4: user.UserService.Create:input_type -> user.CreateUserRequest
	3,  // 5: user.UserService.GetByID:input_type -> user.GetUserRequest
	...
	9,  // 8: user.UserService.CheckPass:input_type -> user.CheckPasswordRequest
	2,  // 9: user.UserService.Create:output_type -> user.CreateUserResponse
	4,  // 10: user.UserService.GetByID:output_type -> user.GetUserResponse
	6,  // 11: user.UserService.Update:output_type -> user.UpdateUserResponse
	8,  // 12: user.UserService.Delete:output_type -> user.DeleteUserResponse
	10, // 13: user.UserService.CheckPass:output_type -> user.CheckPasswordResponse
